...
class Theme_My_Login_Custom_Redirection_Admin extends Theme_My_Login_Abstract {
	...
	public function redirection_meta_box( $object, $box ) {
		...
		<table class="form-table">
			<tr valign="top">
			<th scope="row"><?php _e( 'Авторизація' ); ?></th>
				<td>
			...
			<tr valign="top">
				...
				<td>
					...
					<p class="description"><?php _e( 'Check this option to send the user to the Авторизація page, displaying a message that they have successfully logged out.', 'theme-my-login' ); ?></p>
