...
class Theme_My_Login_User_Moderation_Admin extends Theme_My_Login_Abstract {
	...
	public function settings_field_moderation_type() {
		...
		<p class="description"><?php _e( 'Check this option to require new users to confirm their e-mail address before they may Авторизація.', 'theme-my-login' ); ?></p>
		...
		<p class="description"><?php _e( 'Check this option to require new users to be approved by an administrator before they may Авторизація.', 'theme-my-login' ); ?></p>
		<?php
	}
