...
Tags: widget, login, registration, theme, custom, Авторизація, register, sidebar, gravatar, redirection, e-mail
...
= Features =
* Your registration, Авторизація, and password recovery pages will all match the rest of your website
* Includes a customizable widget to login anywhere from your blog
* Redirect users upon Авторизація and log out based upon their role
...
= 6.4.7 =
* Don't allow locked users to Авторизація using their email address
...
* Don't allow pending users to Авторизація using their email address
...
* Users can now Авторизація with e-mail address as well as username
...
* Implemented custom redirection upon Авторизація based on role
