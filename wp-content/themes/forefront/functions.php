...
function forefront_get_color_defaults( $forefront_color_defaults )
{
	...
	$forefront_color_defaults[ 'navigation_background_color' ] = '#004a8a';
	$forefront_color_defaults[ 'navigation_text_color' ] = '#FFFFFF';
	$forefront_color_defaults[ 'navigation_background_hover_color' ] = '#0f31c3';
	$forefront_color_defaults[ 'navigation_text_hover_color' ] = '#FFFFFF';
	$forefront_color_defaults[ 'navigation_background_current_color' ] = '#0f31c3';
	$forefront_color_defaults[ 'navigation_text_current_color' ] = '#FFFFFF';
	$forefront_color_defaults[ 'subnavigation_background_color' ] = '#0f31c3';
	$forefront_color_defaults[ 'subnavigation_text_color' ] = '#FFFFFF';
	$forefront_color_defaults[ 'subnavigation_background_hover_color' ] = '#2A4EE9';
	$forefront_color_defaults[ 'subnavigation_text_hover_color' ] = '#FFFFFF';
	$forefront_color_defaults[ 'subnavigation_background_current_color' ] = '#2A4EE9';
	...
	$forefront_color_defaults[ 'blog_post_title_hover_color' ] = '#004a8a';
	$forefront_color_defaults[ 'entry_meta_text_color' ] = '#888888';
	$forefront_color_defaults[ 'entry_meta_link_color' ] = '#666666';
	$forefront_color_defaults[ 'entry_meta_link_color_hover' ] = '#004a8a';
	...
	$forefront_color_defaults[ 'sidebar_widget_link_hover_color' ] = '#004a8a';
	...
	$forefront_color_defaults[ 'footer_background_color' ] = '#004a8a';
